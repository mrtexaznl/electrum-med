...
from electrum_med_gui.qt.qrcodewidget import QRCodeWidget
from electrum_med import bmp
from electrum_med_gui.qt import HelpButton, EnterButton
import json
...
from electrum_med import BasePlugin
class Plugin(BasePlugin):
    ...
    def show_raw_qr(self):
        ...
        if not is_valid(to_address):
            QMessageBox.warning(self.gui.main_window, _('Error'), _('Invalid Mediterraneancoin Address') + ':\n' + to_address, _('OK'))
            return
