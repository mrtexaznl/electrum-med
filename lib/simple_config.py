...
"""
    ...
    def read_system_config(self):
        """Parse and store the system config settings in electrum-med.conf into system_config[]."""
        name = '/etc/electrum-med.conf'
        if os.path.exists(name):
            try:
                import ConfigParser
            except ImportError:
                print "cannot parse electrum-med.conf. please install ConfigParser"
                return
