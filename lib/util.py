...
def user_dir():
    if "HOME" in os.environ:
        return os.path.join(os.environ["HOME"], ".electrum-med")
    elif "APPDATA" in os.environ:
        return os.path.join(os.environ["APPDATA"], "Electrum-MED")
    elif "LOCALAPPDATA" in os.environ:
        return os.path.join(os.environ["LOCALAPPDATA"], "Electrum-MED")
    elif 'ANDROID_DATA' in os.environ:
        return "/sdcard/electrum-med/"
    else:
...
def appdata_dir():
    ...
    if platform.system() == "Windows":
        ...
        return os.path.join(sys.prefix, "share", "electrum-med")
    elif (platform.system() == "Darwin" or
          platform.system() == "DragonFly" or
          platform.system() == "OpenBSD" or
          platform.system() == "FreeBSD" or
	  platform.system() == "NetBSD"):
        return "/Library/Application Support/Electrum-MED"
    else:
...
def parse_url(url):
    ...
    assert u.scheme == 'mediterraneancoin'
