...
_ = lambda x:x
#from i18n import _
from electrum_med import mnemonic_encode, WalletStorage, Wallet
from electrum_med.util import format_satoshis, set_verbosity
from electrum_med.bitcoin import is_valid
from electrum_med.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, network):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-med create'"
            exit()
    ...
    def do_send(self):
        if not is_valid(self.str_recipient):
            print(_('Invalid Mediterraneancoin address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-med setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-med setconfig' to change your settings")
        return True
