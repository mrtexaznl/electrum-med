...
from electrum_med.util import print_error, print_msg, parse_url
...
from electrum_med import WalletStorage, Wallet
from electrum_med.i18n import _
from electrum_med.bitcoin import MIN_RELAY_TX_FEE
...
from electrum_med.plugins import init_plugins
...
class ElectrumGui:
    ...
    def build_tray_menu(self):
        ...
        m.addSeparator()
        m.addAction(_("Exit Electrum-MED"), self.close)
    ...
    def set_url(self, url):
        ...
        if amount:
            try:
                if self.main_window.base_unit() == 'mMED': 
        ...
        if request_url:
            try:
                from electrum_med import paymentrequest
            except:
    ...
    def main(self, url):
        ...
        self.tray.setToolTip('Electrum-MED')
