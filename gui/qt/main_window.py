...
from electrum_med.i18n import _, set_language
from electrum_med.util import print_error, print_msg
...
from electrum_med.bitcoin import MIN_RELAY_TX_FEE, is_valid
from electrum_med.plugins import run_hook

import icons_rc

from electrum_med.wallet import format_satoshis
from electrum_med import Transaction
from electrum_med import mnemonic
from electrum_med import util, bitcoin, commands, Interface, Wallet
from electrum_med import SimpleConfig, Wallet, WalletStorage


from electrum_med import bmp, pyqrnative
...
from electrum_med import ELECTRUM_VERSION
import re
...
class ElectrumWindow(QMainWindow):
    ...
    def __init__(self, config, network, gui_object):
        ...
        self.setWindowIcon(QIcon(":icons/electrum-med.png"))
        self.init_menubar()
    ...
    def load_wallet(self, wallet):
        ...
        title = 'Electrum-MED ' + self.wallet.electrum_version + '  -  ' + self.wallet.storage.path
    ...
    def show_about(self):
        QMessageBox.about(self, "Electrum-MED",
            _("Version")+" %s" % (self.wallet.electrum_version) + "\n\n" + _("Electrum's focus is speed, with low resource usage and simplifying Mediterraneancoin. You do not need to perform regular backups, because your wallet can be recovered from a secret phrase that you can memorize or write on paper. Startup times are instant because it operates in conjunction with high-performance servers that handle the most complicated parts of the Mediterraneancoin system."))

    def show_report_bug(self):
        QMessageBox.information(self, "Electrum-MED - " + _("Reporting Bugs"),
            _("Please report any bugs as issues on github:")+" <a href=\"https://github.com/pooler/electrum-med/issues\">https://github.com/pooler/electrum-med/issues</a>")
    ...
    def notify(self, message):
        self.tray.showMessage("Electrum-MED", message, QSystemTrayIcon.Information, 20000)
    ...
    def base_unit(self):
        ...
        return "MED" if self.decimal_point == 8 else "mMED"
    ...
    def create_history_menu(self, position):
        ...
        if be == 'explorer.mediterraneancoin.org':
            ...
            block_explorer = 'https://med.blockr.io/tx/info/'
        if not item: return
    ...
    def create_send_tab(self):
        ...
        grid.addWidget(HelpButton(_('Recipient of the funds.') + '\n\n' + _('You may enter a Mediterraneancoin address, a label from your list of contacts (a list of completions will be proposed), or an alias (email-like address that forwards to a Mediterraneancoin address)')), 1, 4)
        ...
        grid.addWidget(HelpButton(
                _('Mediterraneancoin transactions are in general not free. A transaction fee is paid by the sender of the funds.') + '\n\n'\
    ...
    def do_send(self):
        ...
        if self.gui_object.payment_request:
            ...
            if not is_valid(to_address):
                QMessageBox.warning(self, _('Error'), _('Invalid Mediterraneancoin Address') + ':\n' + to_address, _('OK'))
                return
    ...
    def create_receive_menu(self, position):
        ...
        if not multi_select:
            ...
            menu.addAction(_("QR code"), lambda: self.show_qrcode("mediterraneancoin:" + addr, _("Address")) )
    ...
    def new_account_dialog(self, password):
        ...
        e = QLineEdit()
        vbox.addWidget(e)
        msg = _("Note: Newly created accounts are 'pending' until they receive mediterraneancoins.") + " " \
    ...
    def export_privkeys_dialog(self, password):
        ...
        defaultname = 'electrum-med-private-keys.csv'
    ...
    def do_export_labels(self):
        ...
        try:
            fileName = self.getSaveFileName(_("Select file to save your labels"), 'electrum-med_labels.dat', "*.dat")
            if fileName:
                with open(fileName, 'w+') as f:
                    json.dump(labels, f)
    ...
    def export_history_dialog(self):
        ...
        defaultname = os.path.expanduser('~/electrum-med-history.csv')
    ...
    def settings_dialog(self):
        ...
        from electrum_med.i18n import languages
        ...
        block_explorers = ['explorer.mediterraneancoin.org', 'block-explorer.com', 'Blockr.io']
        block_ex_label = QLabel(_('Online Block Explorer') + ':')
        grid.addWidget(block_ex_label, 5, 0)
        block_ex_combo = QComboBox()
        block_ex_combo.addItems(block_explorers)
        block_ex_combo.setCurrentIndex(block_explorers.index(self.config.get('block_explorer', 'explorer.mediterraneancoin.org')))
        ...
        if self.base_unit() != unit_result:
            self.decimal_point = 8 if unit_result == 'MED' else 5
    ...
    def plugins_dialog(self):
        from electrum_med.plugins import plugins
