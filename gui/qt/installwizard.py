...
from electrum_med import Wallet, Wallet_2of2, Wallet_2of3
import electrum_med.bitcoin as bitcoin
...
MSG_ENTER_ANYTHING    = _("Please enter a wallet seed, a master public key, a list of Mediterraneancoin addresses, or a list of private keys")
...
class InstallWizard(QDialog):
    ...
    def create_cold_seed(self, wallet):
        from electrum_med.bitcoin import mnemonic_to_seed, bip32_root
